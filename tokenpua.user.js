...
`;
  ...
  function injectStyles() {
    const css = [
      ...
      '#tpua-panel .tpua-header{display:flex;align-items:center;justify-content:space-between;padding:10px 16px;border-bottom:1px solid rgba(255,255,255,0.06)}',
      '#tpua-panel .tpua-status{font-weight:600;font-size:16px}',
      '#tpua-panel .tpua-header-actions{display:flex;align-items:center;gap:12px}',
      '#tpua-panel .tpua-refresh-inline{cursor:pointer;font-size:13px;color:#aaa}',
      '#tpua-panel .tpua-refresh-inline:hover{color:#fff}',
      '#tpua-panel .tpua-header-btn{cursor:pointer;opacity:0.5;font-size:18px;padding:0 6px;border-radius:4px}',
      ...
      '#tpua-panel .tpua-block{padding:12px 16px;display:flex;flex-direction:column;justify-content:center;flex:1;min-width:0}',
      ...
      '#tpua-panel .tpua-card-label{font-size:11px;color:#888;margin-top:2px}',
      '#tpua-panel .tpua-section-title{padding:0 0 8px;font-size:12px;color:#888;text-transform:uppercase;letter-spacing:0.5px}',
      '#tpua-panel .tpua-bar-row{display:flex;align-items:center;padding:3px 0;gap:10px}',
      '#tpua-panel .tpua-bar-label{width:32px;font-size:12px;color:#888;text-align:right;flex-shrink:0}',
      '#tpua-panel .tpua-bar-track{flex:1;height:14px;background:rgba(255,255,255,0.06);border-radius:7px;overflow:hidden}',
      '#tpua-panel .tpua-bar-fill{height:100%;border-radius:7px;transition:width 0.4s ease}',
      '#tpua-panel .tpua-bar-num{font-size:12px;color:#aaa;white-space:nowrap;min-width:100px;text-align:left;padding-left:4px}',
